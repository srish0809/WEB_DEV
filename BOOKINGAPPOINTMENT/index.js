function saveToLocalStorage(event){
    ...
    axios.post("https://crudcrud.com/api/e65ebb0066ba43f7b4ba583daeaaf2fa/appointmentData",userdetails)
    .then((response)=>{
...
// const data=axios.get("https://crudcrud.com/api/e65ebb0066ba43f7b4ba583daeaaf2fa/appointmentData")
// .then((response)=>{
//    console.log(response)
...
function deleteuser(userId){
    axios.delete(`https://crudcrud.com/api/e65ebb0066ba43f7b4ba583daeaaf2fa/appointmentData/${userId}`).then((response)=>{
        console.log(response);
